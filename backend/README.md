...
```text
src/main/java/br/com/dariokruger/dbmetricsmonitor
|-- config
|-- controller
|-- dto
|-- exception
...
- Queries SQL: [backend/postgres-monitoring-queries.sql](backend/postgres-monitoring-queries.sql)
- Requests HTTP: [backend/requests.http](backend/requests.http)
