package br.com.dariokruger.dbmetricsmonitor.service;

import br.com.dariokruger.dbmetricsmonitor.config.AppProperties;
import br.com.dariokruger.dbmetricsmonitor.dto.CacheHitRatioResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.ConnectionSummaryResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.DatabaseSettingResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.GroupedConnectionResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.IdleSessionResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.LockInfoResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.QueryStatsResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.RunningQueryResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.TableAccessResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.TableSizeResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.TerminateSessionRequest;
import br.com.dariokruger.dbmetricsmonitor.dto.TerminateSessionResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.TopQueryResponse;
import br.com.dariokruger.dbmetricsmonitor.dto.VacuumHealthResponse;
import br.com.dariokruger.dbmetricsmonitor.exception.BadRequestException;
import br.com.dariokruger.dbmetricsmonitor.exception.DatabaseOperationException;
import br.com.dariokruger.dbmetricsmonitor.exception.ResourceNotFoundException;
import br.com.dariokruger.dbmetricsmonitor.repository.DatabaseMonitoringRepository;
